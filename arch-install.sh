...
PACKAGE_DESKTOP_KDE="plasma kde-applications packagekit-qt5 kio-fuse flatpak fwupd $PACKAGE_DESKTOP_KDE_GLOBALMENU"
...
PACKAGE_EXT_APPS="mpv audacious chromium firefox vlc gimp blender nextcloud-client libreoffice lib32-libpulse picard inkscape audacity pidgin virtualbox-host-modules-arch virtualbox keepassxc wireshark-qt syncthing"
