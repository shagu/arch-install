...
PACKAGES="base-devel cmake linux-firmware linux-headers dosfstools gptfdisk intel-ucode vim openssh git wget htop ncdu screen net-tools unrar unzip p7zip rfkill bind-tools alsa-utils jack2 lvm2"
...
PACKAGE_DESKTOP_KDE="plasma plasma-wayland-session kde-applications packagekit-qt5 flatpak fwupd"
...
PACKAGE_DESKTOP_AWESOME="xorg-xinit awesome alacritty rofi picom nitrogen thunar pavucontrol qutebrowser i3lock"
