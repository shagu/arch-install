...
PACKAGES="base-devel cmake linux-firmware linux-headers dosfstools gptfdisk amd-ucode intel-ucode vim openssh git wget htop ncdu screen net-tools unrar unzip p7zip rfkill bind-tools alsa-utils jack2 lvm2 mdadm"
PACKAGE_DESKTOP="xorg xorg-drivers xorg-apps xf86-input-evdev xf86-input-synaptics lib32-vulkan-intel vulkan-intel lib32-vulkan-radeon vulkan-radeon xcursor-vanilla-dmz xcursor-vanilla-dmz-aa cups nss-mdns libva-utils vainfo libvdpau-va-gl"
...
PACKAGE_DESKTOP_GNOME="gnome gnome-extra gnome-browser-connector flatpak-builder networkmanager"
