...
PACKAGE_DESKTOP="xorg xorg-drivers xorg-apps xf86-input-evdev xf86-input-synaptics lib32-vulkan-intel vulkan-intel lib32-vulkan-radeon vulkan-radeon"
PACKAGE_DESKTOP_GTK="paprefs qt5-styleplugins materia-gtk-theme elementary-icon-theme"
...
PACKAGE_EXT_FONTS="ttf-liberation ttf-ubuntu-font-family ttf-droid ttf-dejavu gnu-free-fonts noto-fonts noto-fonts-extra noto-fonts-emoji"
