...
PACKAGE_DESKTOP_KDE="plasma plasma-wayland-session kde-applications packagekit-qt5 kio-fuse flatpak fwupd"
...
PACKAGE_EXT_APPS="mpv audacious chromium firefox vlc gimp blender nextcloud-client libreoffice lib32-libpulse pulseaudio-zeroconf picard inkscape audacity pidgin virtualbox-host-modules-arch virtualbox keepassxc wireshark-qt syncthing"
