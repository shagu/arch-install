...
PACKAGES="base-devel cmake linux linux-headers mkinitcpio dosfstools gptfdisk intel-ucode vim openssh git wget htop ncdu screen net-tools unrar unzip p7zip rfkill bind-tools alsa-utils"
